    ...
    >
      ...
      <motion.div className="hud-bottom" variants={slideUp}>
        ...
        <div className="hud-bottom-controls">
          {/* Mic — click to speak, auto-stops on silence */}
          <button
            className={`hud-icon-btn ${micActive ? 'active' : ''}`}
            id="btn-mic"
            title={micActive ? 'Listening...' : 'Click to speak'}
            onClick={toggleMic}
          >
          ...
          <button className="hud-icon-btn" id="btn-type-mode" title="Type Mode">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <button className="hud-icon-btn" id="btn-settings" title="Settings">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
